...
class Local_Search_Provider_Lucene implements Local_Search_ProviderInterface
{
    ...
    public function createIndex()
    {
        ...
        $rowSetProject = $tableProject->fetchAll('status = ' . Application_Model_DbTable_Project::PROJECT_ACTIVE .
            ' AND type_id = ' . Application_Model_DbTable_Project::PROJECT_TYPE_STANDARD, 'created_at desc');

        $tableMember = new Application_Model_Member();
        $tableCategory = new Application_Model_DbTable_ProjectCategory();
        $helperBuildProductUrl = new Application_View_Helper_BuildProductUrl();
        ...
        foreach ($rowSetProject as $project) {
            ...
            if (null != $member->username) {
                ...
                $isUpdate = ($project->type_id == Application_Model_DbTable_Project::PROJECT_TYPE_UPDATE);
                if ($isUpdate) {
    ...
    {
        $modelStoreCategories = new Application_Model_DbTable_ConfigStoreCategory();
    ...
    {
        $modelProduct = new Application_Model_Project();
    ...
    protected function createIndexDocument($element)
    {
        ...
        $isUpdate = ($element['type_id'] == Application_Model_DbTable_Project::PROJECT_TYPE_UPDATE);
        $helperBuildProductUrl = new Application_View_Helper_BuildProductUrl();
        if ($isUpdate) {
