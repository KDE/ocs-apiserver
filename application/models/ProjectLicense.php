 ...
 **/
class Application_Model_ProjectLicense
{
     ...
     * @param $project_id
     *
     * @return Application_Model_DbRow_ProjectCcLicense
     */
    public function findOneProject($project_id)
    {
        $resultRow = $this->_dataTable->fetchRow(array('project_id = ?' => $project_id));
        if (empty($resultRow)) {
            $resultRow = $this->_dataTable->createRow(array(), Application_Model_DbTable_ProjectCcLicense::DEFAULT_CLASS);
        }
