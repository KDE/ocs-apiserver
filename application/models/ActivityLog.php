 ...
 **/
class Application_Model_ActivityLog extends Application_Model_DbTable_ActivityLog
{
    ...
    public function writeActivityLog($objectId, $userId, $activity_type_id, $data)
    {
        ...
        //is it an item?
        if (isset($data['type_id']) && $data['type_id'] == Application_Model_Project::PROJECT_TYPE_UPDATE) {
            $projectId = $data['pid'];
        }
        $object_text =
